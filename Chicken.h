...
#ifndef __L4RC_GAME_CHICKEN_H__
#define __L4RC_GAME_CHICKEN_H__
#include <Windows.h>
#include "shellapi.h"
...
public:
    CChicken(eSprite t, const Vector2& p); ///< Constructor.
    virtual ~CChicken(); ///< Destructor.
